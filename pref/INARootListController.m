 ...
 */
-(void)apply {
  UIAlertController *killConfirm = [UIAlertController alertControllerWithTitle:@TWEAK_TITLE message:[HaoPSUtil localizedItem:@"DO_YOU_REALLY_WANT_TO_KILL_INSTAGRAM"] preferredStyle:UIAlertControllerStyleAlert];
  UIAlertAction *confirmAction = [UIAlertAction actionWithTitle:[HaoPSUtil localizedItem:@"CONFIRM"] style:UIAlertActionStyleDestructive handler:^(UIAlertAction * action) {
    ...
    [killall setArguments:@[@"-9", @"Instagram"]];
    [killall launch];
  }];
